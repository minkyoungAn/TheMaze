...
//void Delay_us(unsigned char time_us);			    // time delay for us (1~255 us)
//void Delay_ms(unsigned int time_ms);			    // time delay for ms (1~65535 ms)
...
//void TFT_xy(unsigned char xChar, unsigned char yChar);		        // set character position
...
#if 0
#define KEY1		0x04			// KEY1 value
#define KEY2		0x08			// KEY2 value
#define KEY3		0x10			// KEY3 value
#define KEY4		0x20			// KEY4 value
#endif
